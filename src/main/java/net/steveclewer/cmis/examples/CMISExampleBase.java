...
public class CMISExampleBase extends ExampleBase {
	...
	public Document createTestDoc(String docName, String contentType) {
		...
		properties.put(PropertyIds.OBJECT_TYPE_ID, "D:cam:cameraType");
		properties.put(PropertyIds.NAME, filename);
		properties.put("cam:cameraModel", "Canon 650D");
		properties.put("cam:cameraPrice", 666);
		...
		*/
		...
		Document doc = folder.createDocument(properties, contentStream, VersioningState.MAJOR); System.out.println("Created: " + doc.getId());
	...
	{
		CMISExampleBase thing = new CMISExampleBase();
		thing.setUser("admin");
		thing.setPassword("admin");
		thing.setFolderName("Data Dictionary");
		
		thing.createTestDoc("cmisTest", "whatever");
	}
}